...
## 2. Voice fires on surprise/decision/discovery beats — not a uniformly lowered thres
...
## 10. When the user frames code as "X wrote this" during a bad-mood audit, verify auth
