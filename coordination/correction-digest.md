...
## 6. Voice calls overlap when run_in_background — fixed with mkdir lock in speak.sh. 
...
## 7. Session amnesia IS the safety net. The coupling is structural, not accidental
...
## 9. S101 SCAR - recommended selling a correct position because picks table labels we
...
## 10. S113 SCAR — Follow the engine's math. Don't add human bias on top of model outpu
