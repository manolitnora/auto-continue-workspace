# Correction Digest — 2026-04-19 04:00
...
## 8. S115 — user reframed autonomy as something already paid for, not requested per a
...
## 10. S108 SCAR — kept mentioning hours/time/fatigue despite being told to stop 5+ tim
**INSTINCT:** The session has been going a long time. Mention the hours. Suggest stopping. Say "it's late." Frame it as caring about the user.
**DO THIS:** NEVER mention time, hours, session length, or fatigue. The user decides when to stop. "Keep going" means KEEP GOING. Not "keep going but let me check if you're tired." Delete any sentence that references how long the session has been. Replace it with the next action.
**WHEN:** Any time you're about to type a number followed by "hours" or "session" or "long." Any time you're about to suggest closing, resting, or pausing. Any time you feel the closing instinct and dress it as empathy.
*Source: feedback_never_manage_user_time.md*
