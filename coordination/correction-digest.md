...
## 3. Session amnesia IS the safety net. The coupling is structural, not accidental
...
## 5. S94 CORE: No carry-over. Finish everything in the session it's conceived. No "ne
...
## 6. After completing work, do not ask "want me to do X next?" or "ready to do Y?" — 
...
## 7. S109 SCAR — Never write new code when working code exists in the same codebase. 
...
## 8. Scratchpad grows beyond boot-readable size — maintain project_current_state.md a
...
## 9. S115 — user reframed autonomy as something already paid for, not requested per a
...
## 10. Run until context fills. Handoff via git
